    ...
    describe('GerritLabel is available', () => {
      beforeEach(() => {
        mergeToConfig({
          approveAvailable: true,
          labelMappings: {
            'renovate/stability-days': 'Stability',
            'renovate/merge-confidence': 'Merge-Confidence',
          },
          labels: {
            Stability: {
      ...
      it.each([
        {
          ...
          labels: { Stability: { rejected: {} } },
          expectedState: 'red' as BranchStatus,
        },
        {
          ctx: 'renovate/merge-confidence',
          labels: { 'Merge-Confidence': { rejected: {} } },
          expectedState: 'red' as BranchStatus,
        },
        {
          ctx: 'renovate/stability-days',
          labels: { Stability: { approved: {} } },
          expectedState: 'green' as BranchStatus,
        },
        {
          ctx: 'renovate/merge-confidence',
          labels: { 'Merge-Confidence': { approved: {} } },
          expectedState: 'green' as BranchStatus,
        },
    ...
    describe('GerritLabel is available', () => {
      ...
      it.each([
        ...
        },
        {
          ...
          branchState: 'red' as BranchStatus,
          expectedVote: -1,
          expectedLabel: 'Merge-Confidence',
        },
        {
          ctx: 'renovate/merge-confidence',
          branchState: 'yellow' as BranchStatus,
